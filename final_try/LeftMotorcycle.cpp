...
main()
{
  cout << "===== This is the program for left motorcycle =====\n\n";
  ...
  l_moto.passengers = n;
  l_moto.is_selfish = sel;
  l_moto.emergency_direction = s;
  l_moto.is_avoid_way = way;
  l_moto.host_url = "http://127.0.0.1:8881";


  HttpServer httpserver(8881);
